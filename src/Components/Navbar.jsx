...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      {user && (
        <>
          <NavLink to={"/shareTip"}>Share Tip</NavLink>
  ...
  return (
    <nav className="bg-green-400 opacity-90 text-gray-700 rounded-2xl">
        ...
        {isMobileMenuOpen ? (
          <div>
            <div className="hidden">
              <NavLink
                className="btn btn-ghost text-xl font-3xl bg-green-600 italic rounded-4xl
          "
                to={"/"}
              >
